...
--
-- Table structure for table `orden_c`
--
...
CREATE TABLE `orden_c` (
  `idOrden_C` int NOT NULL AUTO_INCREMENT,
  `idCotizacion` int NOT NULL,
  `fecEmi` datetime DEFAULT NULL,
  `fecEntrega` datetime DEFAULT NULL,
  `formaPago` varchar(32) DEFAULT NULL,
  `Orden_Ccol` varchar(45) DEFAULT NULL,
  `desc` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`idOrden_C`),
  KEY `fk_Orden_C_Cotizacion1_idx` (`idCotizacion`),
  CONSTRAINT `fk_Orden_C_Cotizacion1` FOREIGN KEY (`idCotizacion`) REFERENCES `cotizacion` (`idCotizacion`)
