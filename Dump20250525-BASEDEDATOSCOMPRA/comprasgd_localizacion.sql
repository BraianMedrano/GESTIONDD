...
CREATE TABLE `localizacion` (
  ...
  `codpos` int DEFAULT NULL,
  `depto` varchar(64) DEFAULT NULL,
  `piso` int DEFAULT NULL,
  `numero` int DEFAULT NULL,
  `calle` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`idLocalizacion`),
  KEY `fk_Localizacion_Localidad1_idx` (`idLocalidad`),
  CONSTRAINT `fk_Localizacion_Localidad1` FOREIGN KEY (`idLocalidad`) REFERENCES `localidad` (`idLocalidad`)
